...
export default function StatusCard({ service }: { service: Service }) {
  ...
  return (
    <Link
      ...
      className="block bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-gray-700 transition-all hover:bg-gray-900/80"
    >
      ...
      <p className="text-sm text-gray-500 mt-2 truncate">{service.url}</p>
